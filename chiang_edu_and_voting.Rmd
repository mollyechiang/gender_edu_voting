...
Marshall (2015) proved that education attainment significantly increased after the 1947 school-leaving age reform in Great Britain. He deomstrated, using this reform and regression discontinuity design, that as years of schooling increased, so did one's likelihood to vote conservative, also ensuring other covariatives maintained continuity around this cutoff. His explanation for this finding was that increased schooling leads to higher income and then more conservative voting based on economic policies. In my extension of his work, I examined treatment effect heterogenity, specifiacllt how Marshall's results differed when subsetting his data for males and females. 
...
In addition to creating regression discontinuity figures, 
...
combine_plots(m_poly, 
              ...
              title.size = 12,
              sub.text = "The change in proportion of individuals in each class voting conservative around \nthe implementation of the British school-leaving age reform in 1947, subset by \n gender. Curves represent fourth order polynomial fits on either side of the 1947 \ndiscontinuity in (a), as was done in Marshall (2015).")
...
combine_plots(m_linear, 
              ...
              sub.text = "The change in proportion of individuals in each class voting conservative around \nthe implementation of the British school-leaving age reform in 1947, subset by \n gender. Curves represent linear fits on either side of the 1947 discontinuity \nas reccomended by Gelman (2015).")
...
- quick review of Marshall again (and literature on edu --> income --> conservative)
- quick review of replication again
- quick review of main points of extension 
    - mention geldman
- final point on why extension matters
...
![Marshall Decrease in Leaving School after 1947 (Figure 1) Replicated in Stata](Figures/Figure1.png)

![Marshall Continuity Tests (Figure 2) Replicated in Stata](Figures/Figure2.png)

![Marshall Years of Schooling and Voting Conservativue (Figure 3) Replicated in Stata](Figures/Figure3.png)
